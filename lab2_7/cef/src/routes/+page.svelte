<script lang="ts">
	...
	const changeActiveType = (type: string) => {
		...
		nav?.querySelectorAll('.element')[activeType == 'Flights' ? 0 : 1].classList.remove('active');
		activeType = type;
...
<section id="home">
	<div class="findTicket">
		...
		<div class="chooseTicket">
			<div class="container">
				<nav id="navigation">
					<div class="element active" on:click={() => changeActiveType('Flights')}>
					...
					<div class="element" on:click={() => changeActiveType('Stays')}>
						<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
	...
	<div class="container">
		<div class="perfectTrip">
			<div class="titleBlock">
				<div class="left">
					<div class="title">Plan your perfect trip</div>
					<div class="description">Search Flights & Places Hire to our most popular destinations</div>
				</div>
				<div class="right">
					<button on:click={() => sendInfoToServer()}>See more places</button>
				</div>
			</div>
			...
			<div class="trips">
				<div class="element">
					<div class="tripContainer">
						<div class="image">
							<img src="/images/trips/Istanbul.png" alt="">
						</div>
						<div class="text">
							<span class="title">Istanbul, Turkey</span>
							<div class="info">
				...
				<div class="element">
					<div class="tripContainer">
						<div class="image">
							<img src="/images/trips/Sydney.png" alt="">
						</div>
						<div class="text">
							<span class="title">Sydney, Australia</span>
							<div class="info">
								<li><span>Flights</span></li>
								<li><span>Hotels</span></li>
								<li><span>Resorts</span></li>
				...
				<div class="element">
					<div class="tripContainer">
						<div class="image">
							<img src="/images/trips/Baku.png" alt="">
						</div>
						<div class="text">
							<span class="title">Baku, Azerbaijan</span>
							<div class="info">
								<li><span>Flights</span></li>
								<li><span>Hotels</span></li>
								<li><span>Resorts</span></li>
				...
				<div class="element">
					<div class="tripContainer">
						<div class="image">
							<img src="/images/trips/Male.png" alt="">
						</div>
						<div class="text">
							<span class="title">Male, Maldives</span>
							<div class="info">
								<li><span>Flights</span></li>
								<li><span>Hotels</span></li>
								<li><span>Resorts</span></li>
				...
				<div class="element">
					<div class="tripContainer">
						<div class="image">
							<img src="/images/trips/Paris.png" alt="">
						</div>
						<div class="text">
				...
				<div class="element">
					<div class="tripContainer">
						<div class="image">
							<img src="/images/trips/NewYork.png" alt="">
						</div>
						<div class="text">
				...
				<div class="element">
					<div class="tripContainer">
						<div class="image">
							<img src="/images/trips/London.png" alt="">
						</div>
						<div class="text">
				...
				<div class="element">
					<div class="tripContainer">
						<div class="image">
							<img src="/images/trips/Tokyo.png" alt="">
						</div>
						<div class="text">
				...
				<div class="element">
					<div class="tripContainer">
						<div class="image">
							<img src="/images/trips/Dubai.png" alt="">
						</div>
						<div class="text">
							<span class="title">Dubai, UAE</span>
							<div class="info">
								<li><span>Flights</span></li>
								<li><span>Hotels</span></li>
								<li><span>Resorts</span></li>
		...
		<div class="selectType">
			...
			<div class="element">
				...
				<div class="info">
					...
					<button><Icon icon="basil:telegram-solid" /> Show Hotels</button>
				</div>
			</div>
		</div>
	</div>
